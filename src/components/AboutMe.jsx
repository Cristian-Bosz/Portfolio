    ...
    <>
      <section className='container-fluid'>
        <div className="container">        
              <h3 className='title-home mt-5'>{t("title-about")}</h3>
                <div className='row align-items-center'>
                    ...
                    <div className='col-12 col-lg-6 bg-in'>
                        <div className='my-5'>
                          ...
                          <TextConvert text={t("p-about1")} /> </p>
                          <p className='p-about mt-3 mb-5 mx-2'>
                            <TextConvert text={t("p-about2")}/></p>
                          <p className='p-about mt-4 mb-5 mx-2'>
                            <TextConvert text={t("p-about3")}/> </p>





                          <a href="https://drive.google.com/file/d/1QETDe9vhH3UNZChmj-_9VZwf1S7DFX6o/view?usp=sharing" target="_blank"  className='btn btn-danger fw-bold'>{t("cv")}</a>
                        </div>
                    </div>      
                </div>
        </div>
