      ...
      <div className='container'>
        <div className='row align-items-start'>
          ...
          <div className='col-12'>
           ...
           <p className='p-footer text-center mt-5 mb-3'>Si estás buscando a un desarrollador web front-end junior apasionado y motivado, por favor no dudes en contactarme. Me encantaría discutir tus proyectos y cómo podemos trabajar juntos para crear experiencias de usuario excepcionales para tu sitio web.</p>
              ...
              <div className='col-1 social-icon'>
                <motion.div whileHover={{ scale: [null, 1.2, 1.1] }}
                            transition={{  type: "spring", stiffness: 400, damping: 20 }}>
                             <a href="https://wa.me/11134320735" Target="_blank"><i class="bi bi-whatsapp"></i></a> 
                              </motion.div>
